import{_ as s,c as a,o as n,a as e}from"./app.bf70b469.js";const F=JSON.parse('{"title":"Dockerfile","description":"","frontmatter":{},"headers":[],"relativePath":"guide/common/dockerfile.md"}'),o={name:"guide/common/dockerfile.md"},p=e(`<h1 id="dockerfile" tabindex="-1">Dockerfile <a class="header-anchor" href="#dockerfile" aria-hidden="true">#</a></h1><p>The <code>Dockerfile</code> is located in the <code>.kayak</code> directory and looks like this:</p><div class="vp-code-group"><div class="tabs"><input type="radio" name="group--fYya" id="tab-CctjCzt" checked="checked"><label for="tab-CctjCzt">Cypress</label><input type="radio" name="group--fYya" id="tab-GM9iMbS"><label for="tab-GM9iMbS">Playwright</label></div><div class="blocks"><div class="language-docker active"><button title="Copy Code" class="copy"></button><span class="lang">docker</span><pre class="shiki github-dark"><code><span class="line"><span style="color:#FF7B72;">FROM</span><span style="color:#C9D1D9;"> node:16-alpine </span><span style="color:#FF7B72;">AS</span><span style="color:#C9D1D9;"> dependencies</span></span>
